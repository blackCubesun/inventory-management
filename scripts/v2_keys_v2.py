...
# Загружаем плоские (с исправленными Резервами)
...
print(f'Уникальных СТО: {df_keys["СТО"].nunique()}')

df_keys.to_excel(os.path.join(PROCESSED, '_Ключи_v2_испр.xlsx'), index=False)
print('\nСохранено: _Ключи_v2_испр.xlsx')